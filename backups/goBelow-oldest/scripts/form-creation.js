...
var createForm = function(){
	...
	airports_text.append('<h4>Enter the three-letter airport code or the name of the airport from which you plan to depart and to which you plan to arrive.</h4>');
	airports_text.hide();
	...
	date_text.append('<h4>Enter the date range within which you would like to find a flight.</h4>');
	date_text.hide();
	...
	threshold_text.append('<h4>Enter the maximum amount you wish to pay for the flight.</h4>');
	threshold_text.hide();
	...
	main_fieldset.append('<input id="threshold" type="number" name="threshold" style="width:5em;" required>');
	main_fieldset.append('<hr>');
	...
	phone_field.append('<input type="tel" name="phone-number" id="phone-number" style="width:10em;" placeholder="###-###-####" required>');
	phone_field.hide();
